...
public abstract class BrowserActivity extends ThemableBrowserActivity implements BrowserView, UIController, OnClickListener, OnLongClickListener {
    ...
    private synchronized void initialize(Bundle savedInstanceState) {
        ...
        mSearchBackground.setOnClickListener(this);
        mSearchBackground.setOnFocusChangeListener(new OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                if(hasFocus){
                    Log.e(TAG, "mSearchBackground onFocusChange hasFocus");
                    if(mSearch != null){
                    ...
                    Log.e(TAG, "mSearchBackground onFocusChange not Focus");
                }
            }
        });
    ...
    private class SearchListenerClass implements OnKeyListener, OnEditorActionListener,
        ...
        public void onFocusChange(final View v, final boolean hasFocus) {
            ...
            if(hasFocus){
                ...
                Log.e(TAG, "onFOcusChange not Focus");
            }
        }
...
//        mBrowserFrame.setLayoutTransition(new LayoutTransition());
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        if (mSearchBackground.isFocused() || mSearch.isFocused()){
            Log.e(TAG, "onKeyDown === add by huangkaihui ===");
        }
